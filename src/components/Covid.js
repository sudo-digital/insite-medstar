            ...
            <div className='row'>
              <div className='col-xs-12'>
                ...
                <ol>
                  ...
                  <li>The <a className='link' target='_blank' rel='noopener noreferrer' href='https://osse.dc.gov/page/special-education-resource-hub-what-families-students-need-know-year'>Special Education Resource Hub: What Families and Students Need to Know this Year.</a> Is an OSSE sponsored service designed to ensure families of students with disabilities feel equipped and empowered to support their child, in partnership with their child’s school.</li>
                  <li>
                    <Link className='link' to='/resources'>Adult wellbeing video series</Link>
                  </li>
